                    ...
                    <div className="flex mb-1 w-full py-1 px-1 bg-els-mutedbackground rounded-lg text-sm">
                        ...
                        <button
                            className={`flex-1 text-center py-1 font-semibold ${
                                activeTab === 'bookmarks' ? 'text-black-600 bg-els-secondarybackground rounded-md' : 'text-gray-400'
                            }`}
                        ...
                        <button
                            className={`flex-1 text-center py-1 font-semibold ${
                                activeTab === 'faq' ? 'text-black-600 bg-els-secondarybackground rounded-md' : 'text-gray-400'
                            }`}
